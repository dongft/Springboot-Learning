...
//  @ApiImplicitParam(name = "name", value = "用户详细实体user", required = true, dataType = "User")//起始这行可以不需要
  ...
  @ApiOperation(value = "更新用户详细信息", notes = "根据url的id来指定用户，根据传过来的user信息来更新用户详细信息")
  @ApiImplicitParams({
//      @ApiImplicitParam(name = "id", value = "用户ID", required = true, dataType = "Long"),
